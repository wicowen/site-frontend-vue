          ...
          <div>
            ...
            <form  class="space-y-6">
              ...
              <div class="cursor-pointer">
                <img class="google_icon" src="../assets/image/btn_google_signin_light_normal_web.png"  @click="login"/>
              </div>

              <!-- 使用 Google 渲染預設按鈕及 One Tap prompt 並自動登入 -->
              <!-- <GoogleLogin :callback="callback" prompt auto-login/> -->

              <!-- Google One-tap logout-->
              <div class="cursor-pointer"><button @click="handleLogout">Logout</button></div>
            </form>
            <!-- {{data}} -->
          </div>
...
import { googleTokenLogin, googleAuthCodeLogin , googleOneTap, googleSdkLoaded,decodeCredential,googleLogout} from 'vue3-google-login'
...
//     .then(res =>console.log(JSON.parse(res).data.token))
//     .catch(error => console.log('error', error));

// }

const GOOGLE_CLIENT_ID = '38445072162-v4tu1cqeabbefbcoq3df0ues624ghpi4.apps.googleusercontent.com'
...
const callback = (response: { credential: any; }) => {
